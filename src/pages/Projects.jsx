  ...
  return (
    <Container fluid>
      ...
      <Card className="text-center mb-3">
        ...
        <Card.Body>
          <Card.Title>A complete MERN stack project</Card.Title>
          <Card.Text>Its my major project in which I invested most of the time and got a feel of working with excessive lines of code and redux toolkit. Incorporated various features like user authentication, admin features, CRUD operations of products, categories, users. Various other necessary features like favorites, cart, orders, shipping status, payment etc are also included.  </Card.Text>
          <Button href="https://github.com/ManasMahajan2003/Ecommerce-Website" variant="primary" className="m-1">GitHub repository</Button>
        </Card.Body>
      ...
      <Card className="text-center mb-3">
        ...
        <Card.Body>
          ...
          <Button href="https://expense-tracker-app-three-azure.vercel.app/" variant="primary" className="m-1">View project</Button>
          <Button href="https://github.com/ManasMahajan2003/Expense-Tracker-App" variant="primary" className="m-1">GitHub repository</Button>
        </Card.Body>
      ...
      <Card className="text-center mb-3">
        ...
        <Card.Body>
          ...
          <Button href="https://mern-blog-roan.vercel.app/" variant="primary" className="m-1">View project</Button>
      ...
      <Card className="text-center mb-3">
        ...
        <Card.Body>
          ...
          <Button href="https://manasmahajan2003.github.io/Spotify-clone/" variant="primary" className="m-1">View project</Button>
          <Button href="https://github.com/ManasMahajan2003/Spotify-clone" variant="primary" className="m-1">GitHub repository</Button>
        </Card.Body>
